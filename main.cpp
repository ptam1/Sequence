...
#include <cstdlib>   //Provides EXIT_SUCESS
#include "sequence.h"
...
//PostconditionL A menu of choices for this program has been written to cout
void print_menu( );

//Postcondition: The user has been prompted to enter a one-character command
//The next chracter has been read (skipping blanks and newline characters).
